...
export default function ScoreMeter({ score = 0, shouldAnimate = true }) {
            ...
            <div className="relative w-52 h-52">
                <svg className="w-full h-full -rotate-90" viewBox="0 0 220 220">
                    ...
                    <motion.circle
                        ...
                        animate={{ strokeDashoffset: shouldAnimate ? targetDashOffset : targetDashOffset }}
                    ...
                    <motion.circle
                        ...
                        animate={{ strokeDashoffset: shouldAnimate ? targetDashOffset : targetDashOffset, opacity: 0.15 }}
                        transition={{ duration: 1.5, ease: 'easeOut' }}
