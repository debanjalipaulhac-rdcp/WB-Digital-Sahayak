...
function DirectorySchemeCard({ scheme }) {
...
export default async function SchemesPage({ searchParams }) {
    ...
    const catMap = { education: ['SCHOLARSHIP', 'MERIT-CUM-MEANS', 'SCHEME'], health: ['HEALTH'], social: ['FINANCIAL AID', 'GIRL CHILD'], agriculture: ['AGRICULTURE'], women: ['FINANCIAL AID', 'GIRL CHILD'], farmers: ['AGRICULTURE'] }
